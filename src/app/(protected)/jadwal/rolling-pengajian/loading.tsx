...
export default function RollingPengajianLoading() {
  return (
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 bg-white/80 backdrop-blur-md rounded-2xl border border-slate-200/80 p-4 shadow-2xs">
        <div className="flex items-center gap-3">
          ...
          <div className="space-y-2">
            <div className="h-5 w-52 bg-slate-200 rounded-md animate-pulse" />
            <div className="h-3 w-72 bg-slate-100 rounded-md animate-pulse" />
          </div>
        </div>
        <div className="h-8 w-44 bg-indigo-200/60 rounded-xl animate-pulse" />
      </div>
            ...
            <div className="flex items-start justify-between gap-3">
              <div className="space-y-2 flex-1">
                <div className="flex items-center gap-2">
                  ...
                  <div className="h-4 w-20 bg-indigo-100 rounded-full animate-pulse" />
                </div>
